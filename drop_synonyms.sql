...
rem
rem Usage
rem     SQL > @drop_synonyms.sql <schema name>
rem
rem Options
rem
...
prompt Drop synonyms in &&g_current_schema schema for API objects &&g_package_name package installed in &&l_schema_name schema
